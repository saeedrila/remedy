          ...
          <Row className="justify-content-center">
            <Col md={8} lg={6} xl={5}>
                  ...
                  <Row>
                    <Col>
                      <div className="text-primary p-4">
                        <h3 className="text-primary  text-center">Register as Laboratory</h3>
              ...
              <div className="mt-5 text-center">
                <p>
                  Have an account ?{" "}
                  <Link to="/lab-login" className="fw-medium text-primary">
                    {" "}
                    Login now{" "}
                  </Link>{" "}
                </p>
...
export default withRouter(LabRegister);

LabRegister.propTypes = {

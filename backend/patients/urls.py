...
urlpatterns = [
  ...
  path('fetch-per-day-availability-of-sepecialized-doctor', views.FetchAvailableTimingDoctor.as_view(), name='fetch-per-day-availability-of-sepecialized-doctor'),
]
